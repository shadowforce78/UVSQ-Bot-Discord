const config = {
    ...
    development: {
        ...
        guildId: '719633806536998942',
    },
    commands: {
        prefix: 'u!', // For message commands, prefix is required. This can be changed by a database.
    ...
    users: {
        ownerId: '918916801994309752', // The bot owner ID, which is you.
        developers: ['918916801994309752'] // The bot developers, remember to include your account ID with the other account IDs.
    },
